import {
  ...
  import group from "../assets/groupfoto.jpg";
  import group2 from "../assets/grouppicture.jpg";
  import group3 from "../assets/groupfoto.jpg";
  ...
  const galleryImages = [girl1, girl2, group, group2, group3, girl3, girl4, girl5, girl6];
      ...
      return (
        <View>
          <View style={styles.header}>
            <Text style={styles.h3}>Recent moments</Text>
          </View>
