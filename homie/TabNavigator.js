...
export function TabNavigator() {
  return (
    <Tab.Navigator screenOptions={{ headerShown: false, showLabel: false }}>
      ...
      <Tab.Screen
        name={Behomiename}
        component={BehomiescreenStack}
        options={{
          tabBarIcon: ({ focused, color, size }) => (
            <Image
              source={
                focused
                  ? require("./assets/icons/communityFocused.png")
      ...
      <Tab.Screen
        name={Costsplittername}
        component={CostsplitterscreenStack}
        options={{
          tabBarIcon: ({ focused, color, size }) => (
            <Image
              source={
                focused
                  ? require("./assets/icons/costsplitFocused.png")
                  : require("./assets/icons/costsplit.png")
              }
              style={{ width: size, height: size }}
              resizeMode="contain"
            />
        ...
        options={{
          tabBarIcon: ({ focused, color, size }) => (
            <Image
              source={
                focused
                  ? require("./assets/icons/calendarFocused.png")
